...
import com.video_editor.utils.OptiUtils.task
import nl.bravobit.ffmpeg.FFmpeg
import java.io.File

abstract class OptiBaseCreatorDialogFragment : androidx.fragment.app.DialogFragment() {
    ...
    fun isRunning(): Boolean {
        return FFmpeg.getInstance(activity).isCommandRunning(task)
    }
