...
import com.video_editor.adapter.OptiClipArtAdapter
import com.video_editor.adapter.OptiPositionAdapter
import com.video_editor.interfaces.OptiClipArtListener
import com.video_editor.interfaces.OptiFFMpegCallback
import com.video_editor.interfaces.OptiPositionListener
import com.video_editor.utils.OptiConstant
import com.video_editor.utils.OptiUtils
import java.io.File

class OptiAddGifFragment : BottomSheetDialogFragment(), OptiClipArtListener,
    OptiPositionListener,
    OptiFFMpegCallback {

    private var tagName: String = OptiAddGifFragment::class.java.simpleName
    private lateinit var rootView: View
    private lateinit var linearLayoutManagerOne: androidx.recyclerview.widget.LinearLayoutManager
    private lateinit var linearLayoutManagerTwo: androidx.recyclerview.widget.LinearLayoutManager
    private lateinit var rvClipArt: androidx.recyclerview.widget.RecyclerView
    private lateinit var rvPosition: androidx.recyclerview.widget.RecyclerView
    private lateinit var ivClose: ImageView
    private lateinit var ivDone: ImageView
    private var videoFile: File? = null
    private var clipArtFileGIF: ArrayList<String> = ArrayList()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        linearLayoutManagerOne.orientation = androidx.recyclerview.widget.LinearLayoutManager.HORIZONTAL
        rvClipArt.layoutManager = linearLayoutManagerOne
        linearLayoutManagerTwo.orientation = androidx.recyclerview.widget.LinearLayoutManager.HORIZONTAL
        ...
        val file = File(
            ...
            File.separator + OptiConstant.APP_NAME + File.separator + OptiConstant.GIF_FILES + File.separator
        )

        if (file.isDirectory) {
            listFile = file.listFiles()
            for (i in listFile.indices) {
                clipArtFileGIF.add(listFile[i].absolutePath)
            }
        }

        optiClipArtAdapter = OptiClipArtAdapter(clipArtFileGIF, activity!!.applicationContext, this)
    ...
    private fun addClipArtAction(imgPath: String, position: String) {
        ...
        OptiVideoEditor.with(context!!)
            .setType(OptiConstant.VIDEO_GIF_OVERLAY)
            .setFile(videoFile!!)
